				...
				<script>
					...
					$(document).ready(function(){
						...
						$("#submit").on("click", function(){
                            ...
                            // Send an AJAX request to the contact API
			                $.ajax(
		                    {
		                        ...
		                        success: function (response) {
									// Check if the response contains "success" indicating successful submission
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						...
						<div class="contact-form-box">
							...
							<p>Phone: +00961 3 000 000<br> Email: support@tigergearlb.com</p>
						</div>
					</div>
				</div>
			</div>
