<?php
	...
	// Retrieve admin username from the database
	$adminResult = $db->conn->query("SELECT user_name FROM admin");
	$adminRow = mysqli_fetch_assoc($adminResult);
	$adminUsername = $adminRow['user_name'];
...
<head>
    ...
    function drawChart() {
        // Convert JSON data back to a JavaScript array
                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <?php
							...
							if(isset($_GET['update'])){
								...
								// Prepare the form for updating the product
						...
						<form method='POST' id='add-product' action='./API/Admin.php'>
							...
							<p>
								<div class='form-group'>
                                    ...
                                    // Generate the select dropdown for categories
					...
					echo $form;
							...
							else{// Prepare the form for adding a new product
								$form = "<div class='form-title'>
						<h2>Add Product</h2>
					</div>
					<div class='update-form'>
